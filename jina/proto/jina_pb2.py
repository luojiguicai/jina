...
_REQUESTPROTO_RELOADREQUESTPROTO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='path',
            full_name='jina.RequestProto.ReloadRequestProto.path',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_REQUESTPROTO = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='reload',
            full_name='jina.RequestProto.reload',
            index=7,
            number=11,
            type=11,
            cpp_type=10,
    ...
    nested_types=[
        ...
        _REQUESTPROTO_RELOADREQUESTPROTO,
...
_REQUESTPROTO.fields_by_name['reload'].containing_oneof = _REQUESTPROTO.oneofs_by_name[
    'body'
]
...
RequestProto = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        'ReloadRequestProto': _reflection.GeneratedProtocolMessageType(
            'ReloadRequestProto',
            (_message.Message,),
            {
