...
_REQUESTPROTO_RELOADREQUESTPROTO = _descriptor.Descriptor(
  name='ReloadRequestProto',
  full_name='jina.RequestProto.ReloadRequestProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='path', full_name='jina.RequestProto.ReloadRequestProto.path', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_REQUESTPROTO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='reload', full_name='jina.RequestProto.reload', index=7,
      number=11, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='status', full_name='jina.RequestProto.status', index=8,
      number=6, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='routes', full_name='jina.RequestProto.routes', index=9,
      number=8, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='queryset', full_name='jina.RequestProto.queryset', index=10,
  ...
  nested_types=[_REQUESTPROTO_TRAINREQUESTPROTO, _REQUESTPROTO_INDEXREQUESTPROTO, _REQUESTPROTO_UPDATEREQUESTPROTO, _REQUESTPROTO_DELETEREQUESTPROTO, _REQUESTPROTO_SEARCHREQUESTPROTO, _REQUESTPROTO_RELOADREQUESTPROTO, _REQUESTPROTO_CONTROLREQUESTPROTO, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_REQUESTPROTO_RELOADREQUESTPROTO.containing_type = _REQUESTPROTO
...
_REQUESTPROTO.fields_by_name['reload'].message_type = _REQUESTPROTO_RELOADREQUESTPROTO
...
_REQUESTPROTO.oneofs_by_name['body'].fields.append(
  _REQUESTPROTO.fields_by_name['reload'])
_REQUESTPROTO.fields_by_name['reload'].containing_oneof = _REQUESTPROTO.oneofs_by_name['body']
...
RequestProto = _reflection.GeneratedProtocolMessageType('RequestProto', (_message.Message,), {
  ...
  'ReloadRequestProto' : _reflection.GeneratedProtocolMessageType('ReloadRequestProto', (_message.Message,), {
    'DESCRIPTOR' : _REQUESTPROTO_RELOADREQUESTPROTO,
    '__module__' : 'jina_pb2'
    # @@protoc_insertion_point(class_scope:jina.RequestProto.ReloadRequestProto)
    })
  ,
...
_sym_db.RegisterMessage(RequestProto.ReloadRequestProto)
